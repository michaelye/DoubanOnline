...
//        dialog.setIcon(R.drawable.ic_launcher);  
	...
	public static void show(Context context, String title, String message){
        ...
        View customDialog = layoutInflater.inflate(R.layout.layout_dialog_online_desc, null);  
...
//		
//		LayoutInflater layoutInflater = ((Activity)context).getLayoutInflater();  
//        View customDialog = layoutInflater.inflate(R.layout.layout_dialog_login, null);  
//        
//        TextView tvTitle = (TextView)customDialog.findViewById(R.id.tv_title);
//        TextView tvContent = (TextView)customDialog.findViewById(R.id.tv_content);
//        
